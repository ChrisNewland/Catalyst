...
interface SalaryFormProps {
  ...
  /** Optional prefix used to namespace input IDs when two forms appear on the same page. */
  idPrefix?: string;
}

export default function SalaryForm({ input, setInput, idPrefix = "" }: SalaryFormProps) {
  ...
  return (
    <div className="space-y-4">
        ...
        <CardContent className="pt-6">
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor={id("gross")}>Gross salary</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor={id("taxCode")}>Tax code</Label>
                <Input
                  id={id("taxCode")}
                  value={input.taxCode}
              ...
              return (
                <Label
                  ...
                  className={cn(
                    ...
                    selected ? "border-primary bg-primary/5 ring-1 ring-primary/30" : "border-border hover:bg-secondary/60",
                  )}
                >
                  <RadioGroupItem value={p.id} id={lid} className="mt-0.5" />
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {STUDENT_LOAN_OPTIONS.map((o) => {
            ...
            return (
              ...
              >
                <Checkbox id={lid} checked={checked} onCheckedChange={() => toggleLoan(o.id)} className="mt-0.5" />
                <span className="flex flex-col">
      ...
      >
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor={id("bonus")}>Annual bonus / commission</Label>
            <CurrencyInput id={id("bonus")} value={input.bonusAnnual} onChange={(v) => update("bonusAnnual", v)} />
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor={id("secondJob")}>Second job — annual gross (BR tax)</Label>
            <CurrencyInput id={id("secondJob")} value={input.secondJobAnnual} onChange={(v) => update("secondJobAnnual", v)} />
      ...
      >
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor={id("ccv")}>Childcare vouchers (per month)</Label>
            <CurrencyInput
              id={id("ccv")}
          ...
          <div className="space-y-2">
            <Label htmlFor={id("bik")}>Taxable benefits (BIK) — annual cash value</Label>
            <CurrencyInput id={id("bik")} value={input.taxableBenefits} onChange={(v) => update("taxableBenefits", v)} />
            <p className="text-xs text-muted-foreground">
